...
export default function formatDistanceStrict(dirtyDate, dirtyBaseDate, options) {
    ...
    const roundingMethod = String((_c = options === null || options === void 0 ? void 0 : options.roundingMethod) !== null && _c !== void 0 ? _c : 'round');
    ...
    const timezoneOffset = getTimezoneOffsetInMilliseconds(dateRight) -
