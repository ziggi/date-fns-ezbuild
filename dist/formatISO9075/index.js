...
export default function formatISO9075(dirtyDate, options) {
    ...
    const format = String((_a = options === null || options === void 0 ? void 0 : options.format) !== null && _a !== void 0 ? _a : 'extended');
    const representation = String((_b = options === null || options === void 0 ? void 0 : options.representation) !== null && _b !== void 0 ? _b : 'complete');
